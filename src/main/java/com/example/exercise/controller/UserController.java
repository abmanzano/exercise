...
public class UserController {
	...
	public String getSortedUserList(final Model model)
			throws IOException, ParseException, ExecutionException {
		try {
	...
	public String checkUser(@RequestParam(value = "email") String email,
			final Model model) throws JSONException, IOException,
			ParseException, ExecutionException {
		// Add some email validator and if not a valid email pass a message in
		// error variable
